#!/usr/bin/env python3
"""
Test script specifically for AIO.py

Tests all functionality in the all-in-one file to ensure it works correctly.
"""
...
# Import from AIO.py instead of separate modules
...
class TestPipeline:
    """Comprehensive test pipeline for AIO.py"""
    ...
    def test_cnf_validation(self):
        ...
        for filename in valid_files:
            ...
            is_cnf_result, message = AIO.check_cnf_file(filepath)
    ...
    def test_membership(self):
        ...
        for grammar_file, test_string, expected, description in test_cases:
            ...
            try:
                ...
                is_cnf_result, msg = AIO.check_cnf_file(grammar_path)
    ...
    def test_feasibility(self):
        ...
        for grammar_file, string_length, expected_feasible, description in test_cases:
            ...
            try:
                ...
                feasible, explanation = AIO.is_feasible(grammar, string_length)
    ...
    def test_cli_interface(self):
        ...
        test_cases = [
            ...
            (["python3", "AIO.py", "check_cnf", "examples/simple_cnf.txt"], "YES", "Check CNF command"),
            (["python3", "AIO.py", "check_cnf", "examples/invalid_cnf1.txt"], "NO", "Check invalid CNF"),
            (["python3", "AIO.py", "test_membership", "examples/simple_cnf.txt", "ab"], "YES", "Test membership YES"),
            (["python3", "AIO.py", "test_membership", "examples/simple_cnf.txt", "aa"], "NO", "Test membership NO"),
            (["python3", "AIO.py", "estimate", "examples/simple_cnf.txt", "5"], "YES", "Estimate feasibility"),
        ]
    ...
    def run_all_tests(self):
        """Run all test suites"""
        print("\n" + "=" * 80)
        print("COMPREHENSIVE TEST PIPELINE FOR AIO.PY")
        print("=" * 80)
