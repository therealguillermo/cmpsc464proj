...
# Convenience function to test string membership in a CNF grammar.
#
# A simplified interface for membership testing that creates a MembershipTester
# internally and calls test_membership(). Useful for quick one-off tests without
# needing to manage a MembershipTester object.
#
# Args:
#     grammar (Grammar): The CNF grammar to test against. Should be a valid
#                      Grammar object with CNF-compliant rules.
#     string (str): The string to test for membership. Use '' for epsilon.
#
# Returns:
...
# Example:
#     >>> grammar = parse_grammar_file("grammar.txt")
#     >>> test_membership(grammar, "ab")
#     True
#     >>> test_membership(grammar, "aa")
#     False
#     >>> test_membership(grammar, "")  # Test epsilon
#     True
#
# Note:
#     This function creates a new MembershipTester for each call. If testing
#     multiple strings against the same grammar, it's more efficient to create
#     a MembershipTester once and reuse it.
